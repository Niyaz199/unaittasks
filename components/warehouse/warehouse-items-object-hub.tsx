      ...
      <div className="warehouse-items-hub">
        ...
        <div className="warehouse-items-hub-grid">
          {filteredSummaries.map((item) => (
            <article key={item.object_id} className="section-card warehouse-items-hub-card">
              ...
              <div className="warehouse-items-hub-actions">
                <Link className="btn btn-accent" href={`/warehouse/items?objectId=${item.object_id}`}>
                  Открыть объект
                </Link>
              </div>
            </article>
