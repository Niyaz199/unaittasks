...
-- Targets schema after migrations `0019_object_rooms_and_ppr_system_refactor.sql`
-- and `0020_ppr_cleanup_legacy_structure.sql`.
--
-- Before running:
...
begin
  ...
  insert into public.object_rooms (id, object_id, name, floor, description, is_active)
  values
    ('51000000-0000-4000-8000-000000000001', '11111111-1111-4111-8111-111111111111', 'Серверная А', '1', 'Основной зал серверов', true),
    ('51000000-0000-4000-8000-000000000002', '11111111-1111-4111-8111-111111111111', 'Машзал 1', '1', 'Приточные установки', true),
    ('51000000-0000-4000-8000-000000000003', '11111111-1111-4111-8111-111111111111', 'Машзал 2', '2', 'Чиллерная группа', true),
    ('51000000-0000-4000-8000-000000000004', '11111111-1111-4111-8111-111111111111', 'ИБП', '1', 'Помещение ИБП и аккумуляторов', true),
    ('51000000-0000-4000-8000-000000000005', '11111111-1111-4111-8111-111111111111', 'Щитовая А', '1', 'Щитовая и пульт ПС', true),
    ('51000000-0000-4000-8000-000000000006', '22222222-2222-4222-8222-222222222222', 'Склад 1', '1', 'Основная складская зона', true),
    ('51000000-0000-4000-8000-000000000007', '22222222-2222-4222-8222-222222222222', 'Склад 2', '1', 'Дополнительная складская зона', true),
    ('51000000-0000-4000-8000-000000000008', '22222222-2222-4222-8222-222222222222', 'Электрощитовая', '1', 'Силовые шкафы и АВР', true),
    ('51000000-0000-4000-8000-000000000009', '22222222-2222-4222-8222-222222222222', 'КПП', '1', 'Точка доступа персонала', true),
    ('51000000-0000-4000-8000-000000000010', '22222222-2222-4222-8222-222222222222', 'Холодильная камера', '1', 'Камера хранения температурного режима', true);
